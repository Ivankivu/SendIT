...
class DBconnect:
    ...
    def __enter__(self):
        try:
            ...
            #     return self.cursor
            # if app_config['testing']:
            #     self.conn = psycopg2.connect("dbname = 'd2n8htlj0r4mqh' user = 'nqmldnviazkcxqs' host = 'ec2-54-83-8-246.compute-1.amazonaws.com' password = 'postgres' port = '5432'")
            #     self.cursor = self.conn.cursor()
            #     return self.cursor
            # else app_config['production']:
